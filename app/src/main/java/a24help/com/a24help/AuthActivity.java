...
public class AuthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleApiClient = new GoogleApiClient.Builder(AuthActivity.this)
    ...
    public void FirebaseUserAuth(GoogleSignInAccount googleSignInAccount) {
        ...
        Toast.makeText(AuthActivity.this, "" + authCredential.getProvider(), Toast.LENGTH_LONG).show();

        firebaseAuth.signInWithCredential(authCredential)
                .addOnCompleteListener(AuthActivity.this, new OnCompleteListener() {
                    @Override
